...
(function (window, angular) {
    ...
    angular.module('fms').controller('HomeCtrl', ['$scope', '$state', '$timeout', '$interval', 'UploaderService', 'ImportService', 'DialogManager',
        function ($scope, $state, $timeout, $interval, UploaderService, ImportService, DialogManager) {
